...
import com.vivek.splitwise.models.expense.ExpenseType;
...
import com.vivek.splitwise.service.ExpenseManager;
...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        expenseManager.addUser(new User("u2", "User2", "user2@email.com", "1234567891"));
        expenseManager.addUser(new User("u3", "User3", "user3@email.com", "1234567892"));
        expenseManager.addUser(new User("u4", "User4", "user4@email.com", "1234567893"));
